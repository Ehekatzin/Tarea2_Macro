...
base_master <- read_excel("base_inciso e_fred.xlsx")
...
```{r include=FALSE}
base_ifb <- read_excel("base_ifb.xlsx")
```
...
```{r}
base_e_tiie <- read_excel("base_inciso e_tiie.xlsx")

base_e_fred <- read_excel("base_inciso e_fred.xlsx")
```
...
```{r}
base_f <- read_excel("base_inciso f.xlsx")
```
