...
Por su parte, en el gráfico del tipo de interés con los datos de tipo de interés nominal de la FRED, observamos en primer lugar que si nos concentramos en la serie desde 1995 hasta 2020, el comportamiento de la serie es muy similar a la de la serie anterior que se construyó con los datos de la TIIE del Banxico, por lo que no hay diferencia sustancial en las dos series durante el periodo 1995-2020. Por otra parte, en el periodo 1980-1995 se observan grandes oscilaciones en la serie, con valores negativos muy altos, como ocurre en el primer trimestre de 1983 (-59%) y en particular en el segundo trimestre de 1988 (-85%). 
...
stargazer(reg4, reg5, reg6, 
          ...
          dep.var.caption = "Variable Dependiente",
          dep.var.labels = c("Variación Inversión (I)"),
          covariate.labels =  c("Tasa interés real (r)", "Variación de r", "Variación Producto (Y)", "Variación del rezago de Y", "Variación del rezago de I", "Variación del rezago de r"),
          type="latex",
